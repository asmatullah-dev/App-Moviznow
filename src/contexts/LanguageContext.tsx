...
const translations: Record<string, Record<Language, string>> = {
  ...
  'Get 10 Days Free Basic Access!': { en: 'Get 10 Days Free Basic Access!', 'ur-roman': '10 din Ka Muft Basic Access Haasil Karein!', ur: '10 دن کی مفت Basic رسائی حاصل کریں!' },
  'Invite friends to MovizNow and unlock 10 days of free Basic access for both of you!': { en: 'Invite friends to MovizNow and unlock 10 days of free Basic access for both of you!', 'ur-roman': 'Doston ko MovizNow par invite karein aur dono ke liye 10 din ki free Basic membership haasil karein!', ur: 'دوستوں کو MovizNow پر مدعو کریں اور آپ دونوں کے لیے 10 دن کی مفت بیسک رسائی حاصل کریں!' },
  'Invite & Earn 10 Days Free': { en: 'Invite & Earn 10 Days Free', 'ur-roman': 'Invite Karein & 10 din Muft Jeetein', ur: 'مدعو کریں اور 10 دن مفت حاصل کریں' },
  ...
  '+10 Days Basic': { en: '+10 Days Basic', 'ur-roman': '+10 Din Basic', ur: '10+ دن Basic' },
  'Get 10 days of free Basic membership on MovizNow!': { en: 'Get 10 days of free Basic membership on MovizNow!', 'ur-roman': 'MovizNow par 10 din ki muft Basic membership haasil karein!', ur: 'MovizNow پر 10 دن کی مفت بیسک ممبرشپ حاصل کریں!' },
  ...
  'Invite friends and both of you get 10 days of Basic access instantly!': { en: 'Invite friends and both of you get 10 days of Basic access instantly!', 'ur-roman': 'Doston ko invite karein aur dono ko foran 10 din ki Basic membership milegi!', ur: 'دوستوں کو مدعو کریں اور آپ دونوں کو فوری طور پر 10 دن کی بیسک ممبرشپ ملے گی!' },
  ...
  'Get 6 days of extra membership by enabling push notifications for updates.': { en: 'Get 6 days of extra membership by enabling push notifications for updates.', 'ur-roman': 'Updates ke liye push notifications on karein aur 6 din ki extra membership haasil karein.', ur: 'اپ ڈیٹس کے لیے پش نوٹیفیکیشنز کو فعال کر کے 6 دن کی اضافی ممبرشپ حاصل کریں۔' },
  ...
  'Both you and your friend get 10 days of Basic access instantly when they sign up!': { en: 'Both you and your friend get 10 days of Basic access instantly when they sign up!', 'ur-roman': 'Dost ke sign up karne par aap dono ko foran 10 din ki Basic membership milegi!', ur: 'دوست کے سائن اپ کرنے پر آپ دونوں کو فوری طور پر 10 دن کی بیسک ممبرشپ ملے گی!' },
  'Get another 10 days for yourself when your friend activates their membership.': { en: 'Get another 10 days for yourself when your friend activates their membership.', 'ur-roman': 'Jab aapka dost apni membership activate karega to aapko mazeed 10 din milenge.', ur: 'جب آپ کا دوست اپنی ممبرشپ فعال کرے گا تو آپ کو مزید 10 دن ملیں گے۔' },
  ...
  'Referral Signup (+10 Days)': { en: 'Referral Signup (+10 Days)', 'ur-roman': 'Referral Signup (+10 Din)', ur: 'ریفرل سائن اپ (+10 دن)' },
  'Share your link/code with friends to get 10 days extension for every friend who joins.': { en: 'Share your link/code with friends to get 10 days extension for every friend who joins.', 'ur-roman': 'Doston ke sath apna link/code share karein aur har join karne wale dost par 10 din ki meaad barhayein.', ur: 'دوستوں کے ساتھ اپنا لنک/کوڈ شیئر کریں اور ہر شامل ہونے والے دوست پر 10 دن کی میعاد بڑھائیں۔' },
  'Referral Activation (+10 Days)': { en: 'Referral Activation (+10 Days)', 'ur-roman': 'Referral Activation (+10 Din)', ur: 'ریفرل ایکٹیویشن (+10 دن)' },
  'Get an extra 10 days extension when your referred friend purchases a membership.': { en: 'Get an extra 10 days extension when your referred friend purchases a membership.', 'ur-roman': 'Jab aapka referred dost membership khareeday ga to zafi 10 din barhayein.', ur: 'جب آپ کا ریفر کردہ دوست ممبرشپ خریدے گا تو اضافی 10 دن حاصل کریں۔' },
  'Install App (+6 Days)': { en: 'Install App (+6 Days)', 'ur-roman': 'App Install Karein (+6 Din)', ur: 'ایپ انسٹال کریں (+6 دن)' },
  'Install our PWA app on your home screen for a 6 days membership extension.': { en: 'Install our PWA app on your home screen for a 6 days membership extension.', 'ur-roman': '6 din ki membership barhane ke liye hamari PWA app ko home screen par install karein.', ur: '6 دن کی ممبرشپ کی میعاد بڑھانے کے لیے ہماری PWA ایپ کو ہوم اسکرین پر انسٹال کریں۔' },
  'Enable Notifications (+6 Days)': { en: 'Enable Notifications (+6 Days)', 'ur-roman': 'Notifications On Karein (+6 Din)', ur: 'اطلاعات فعال کریں (+6 دن)' },
  'Enable push notifications to stay updated and get a 6 days membership extension.': { en: 'Enable push notifications to stay updated and get a 6 days membership extension.', 'ur-roman': 'Bakhabar rehne aur 6 din ki membership barhane ke liye push notifications on karein.', ur: 'باخبر رہنے اور 6 دن کی ممبرشپ کی میعاد بڑھانے کے لیے پش اطلاعات کو فعال کریں۔' },
  'Submit a Review (+10 Days)': { en: 'Submit a Review (+10 Days)', 'ur-roman': 'Review Bhejein (+10 Din)', ur: 'جائزہ جمع کریں (+10 دن)' },
  'Write a review and rate our app to get a free 10 days membership extension.': { en: 'Write a review and rate our app to get a free 10 days membership extension.', 'ur-roman': 'Muft 10 din ki membership barhane ke liye review likhein aur hamari app ko rate karein.', ur: 'مفت 10 دن کی ممبرشپ کی میعاد بڑھانے کے لیے جائزہ لکھیں اور ہماری ایپ کو درجہ دیں۔' },
  ...
  'Write Review (+10 Days)': { en: 'Write Review (+10 Days)', 'ur-roman': 'Review Likhein (+10 Din)', ur: 'جائزہ لکھیں (+10 دن)' },
  'Claim Reward (+6 Days)': { en: 'Claim Reward (+6 Days)', 'ur-roman': 'Inam Claim Karein (+6 Din)', ur: 'انعام حاصل کریں (+6 دن)' },
  'Enable (+6 Days)': { en: 'Enable (+6 Days)', 'ur-roman': 'On Karein (+6 Din)', ur: 'فعال کریں (+6 دن)' },
  'Install (+6 Days)': { en: 'Install (+6 Days)', 'ur-roman': 'Install Karein (+6 Din)', ur: 'انسٹال کریں (+6 دن)' },
  'Claimed (+6 Days)': { en: 'Claimed (+6 Days)', 'ur-roman': 'Claim Ho Gaya (+6 Din)', ur: 'حاصل کر لیا (+6 دن)' },
  ...
  'Buy VIP membership to access offline': { en: 'Buy VIP membership to access offline', 'ur-roman': 'Offline dekhnay ke liye VIP Membership khareedein', ur: 'آف لائن رسائی کے لیے وی آئی پی ممبرشپ خریدیں' },
  'Buy VIP Membership': { en: 'Buy VIP Membership', 'ur-roman': 'VIP Membership Khareedein', ur: 'وی آئی پی ممبرشپ خریدیں' },
  'Login to access offline': { en: 'Login to access offline', 'ur-roman': 'Offline dekhnay ke liye login karein', ur: 'آف لائن رسائی کے لیے لاگ ان کریں' },
  'Please connect to the internet and login to enjoy offline access.': { en: 'Please connect to the internet and login to enjoy offline access.', 'ur-roman': 'Internet connect karein aur offline dekhnay ke liye login karein.', ur: 'براہ کرم انٹرنیٹ سے جڑیں اور آف لائن رسائی سے لطف اندوز ہونے کے لیے لاگ ان کریں۔' },
  'Login to Access': { en: 'Login to Access', 'ur-roman': 'Login karein', ur: 'لاگ ان کریں' },
  ...
  'Banner Ads Only': { en: 'Banner Ads Only', 'ur-roman': 'Sirf Banner Ads', ur: 'صرف بینر اشتہارات' },
  'Banner ads only (No popups)': { en: 'Banner ads only (No popups)', 'ur-roman': 'Sirf banner ads (Koi popup nahi)', ur: 'صرف بینر اشتہارات (کوئی پاپ اپ نہیں)' },
  'Banner Ads Only (No Popups)': { en: 'Banner Ads Only (No Popups)', 'ur-roman': 'Sirf Banner Ads (Koi Popups Nahi)', ur: 'صرف بینر اشتہارات (کوئی پاپ اپ نہیں)' },
  'Basic User (Banner Ads Only)': { en: 'Basic User', 'ur-roman': 'Basic User', ur: 'بیسک صارف' },
  'Basic (Banner Ads Only)': { en: 'Basic', 'ur-roman': 'Basic', ur: 'بیسک' },
  'Basic Plans': { en: 'Basic Plans', 'ur-roman': 'Basic Plans', ur: 'بیسک پلانز' },
  'Has some banners': { en: 'Has some banners', 'ur-roman': 'Kuch banners hain', ur: 'کچھ بینرز ہیں' },
  'No': { en: 'No', 'ur-roman': 'Nahi', ur: 'نہیں' },
  'Ads': { en: 'Ads', 'ur-roman': 'Ads', ur: 'اشتہارات' },
  'Same for Basic & VIP': { en: 'Same for Basic & VIP', 'ur-roman': 'Basic aur VIP dono ke liye same', ur: 'بیسک اور وی آئی پی دونوں کے لیے یکساں' },
  'Included in Both': { en: 'Included in Both', 'ur-roman': 'Dono mein shaamil', ur: 'دونوں میں شامل' },
  'Plan Differences': { en: 'Plan Differences', 'ur-roman': 'Plans mein farq', ur: 'پلانز میں فرق' },
  ...
  'Sync failed. Will retry automatically.': { en: 'Sync failed. Will retry automatically.', 'ur-roman': 'Sync nakam hua. Dobara koshish hogi.', ur: 'مطابقت پذیری ناکام ہو گئی۔ خود بخود دوبارہ کوشش کی جائے گی۔' },
  'Refresh failed. Please check connection.': { en: 'Refresh failed. Please check connection.', 'ur-roman': 'Refresh nakam hua. Internet check karein.', ur: 'ریفریش ناکام ہو گیا۔ براہ کرم انٹرنیٹ کنکشن چیک کریں۔' },
  'User ID not found / session expired.': { en: 'User ID not found / session expired.', 'ur-roman': 'User ID nahi mili / session khatam ho gaya.', ur: 'صارف کی شناخت نہیں ملی / سیشن ختم ہو گیا۔' },
  'Profile refresh failed. Please retry.': { en: 'Profile refresh failed. Please retry.', 'ur-roman': 'Profile refresh nakam hui. Dobara try karein.', ur: 'پروفائل ریفریش ناکام ہو گئی۔ براہ کرم دوبارہ کوشش کریں۔' },
  'Session invalid / user deleted. Logging out...': { en: 'Session invalid / user deleted. Logging out...', 'ur-roman': 'Session invalid / user delete ho gaya. Sign out ho raha hai...', ur: 'سیشن غلط ہے / صارف کو حذف کر دیا گیا۔ سائن آؤٹ کیا جا رہا ہے...' },
  ...
  'Upcoming Episode': { en: 'Upcoming Episode', 'ur-roman': 'Anay Wali Episode', ur: 'آنے والی قسط' },
  'Upcoming Episodes': { en: 'Upcoming Episodes', 'ur-roman': 'Anay Wali Episodes', ur: 'آنے والی اقساط' },
  'Notify Me': { en: 'Notify Me', 'ur-roman': 'Mujhe Ittila Karein', ur: 'مجھے اطلاع دیں' },
  'Subscribed for Release Notification': { en: 'Subscribed for Release Notification', 'ur-roman': 'Release Notification Set Ho Gaya', ur: 'اطلاع کی رجسٹریشن ہو گئی' },
  'Notify Me when Episode Releases': { en: 'Notify Me when Episode Releases', 'ur-roman': 'Episode anay par mujhe ittila karein', ur: 'قسط آنے پر مجھے اطلاع دیں' },
  'Notify Me for Full Season': { en: 'Notify Me for Full Season', 'ur-roman': 'Mukammal Season ke Liye Mujhe Ittila Karein', ur: 'مکمل سیزن کے لیے مجھے اطلاع دیں' },
  'Expected Air Date': { en: 'Expected Air Date', 'ur-roman': 'Tawaqqo Shuda Tareekh', ur: 'متوقع تاریخ' },
  'This movie is upcoming and will be available for streaming and download soon.': { en: 'This movie is upcoming and will be available for streaming and download soon.', 'ur-roman': 'Yeh movie anay wali hai aur jald hi stream aur download ke liye dastyab hogi.', ur: 'یہ مووی عنقریب آنے والی ہے اور جلد ہی اسٹریمنگ اور ڈاؤن لوڈ کے لیے دستیاب ہوگی۔' },
  'This season is upcoming and will be available soon.': { en: 'This season is upcoming and will be available soon.', 'ur-roman': 'Yeh season anay wala hai aur jald dastyab hoga.', ur: 'یہ سیزن عنقریب آنے والا ہے اور جلد دستیاب ہوگا۔' },
  'Click to View More': { en: 'Click Poster to View More', 'ur-roman': 'Mazeed Dekhne Ke Liye Poster Per Click Karein', ur: 'مزید دیکھنے کے لیے پوسٹر پر کلک کریں' },
  'Click Poster to View More': { en: 'Click Poster to View More', 'ur-roman': 'Mazeed Dekhne Ke Liye Poster Per Click Karein', ur: 'مزید دیکھنے کے لیے پوسٹر پر کلک کریں' },
  ...
  'Sender Account No': { en: 'Sender Account No', 'ur-roman': 'Sender Account No', ur: 'ارسال کنندہ کا اکاؤنٹ نمبر' },
  'Sender Account No (Last 4 Digits)': { en: 'Sender Account No (Last 4 Digits)', 'ur-roman': 'Sender Account No (Aakhri 4 Digits)', ur: 'ارسال کنندہ کا اکاؤنٹ نمبر (آخری 4 ہندسے)' },
  'Sender Account Title (Name)': { en: 'Sender Account Title (Name)', 'ur-roman': 'Sender Account Title (Naam)', ur: 'ارسال کنندہ کا اکاؤنٹ ٹائٹل (نام)' },
  'Last 4 digits of your account/wallet from which you sent payment': { en: 'Last 4 digits of your account/wallet from which you sent payment', 'ur-roman': 'Aapke wallet/account ke aakhri 4 digits jahan se payment bheji', ur: 'آپ کے اکاؤنٹ یا والٹ کے آخری 4 ہندسے جہاں سے آپ نے رقم بھیجی' },
  'Missing Sender Account Number': { en: 'Missing Sender Account Number', 'ur-roman': 'Sender Account Number Gayab Hai', ur: 'ارسال کنندہ کا اکاؤنٹ نمبر درج کریں' },
  'Please enter the last 4 digits of your sender mobile or bank account number.': { en: 'Please enter the last 4 digits of your sender mobile or bank account number.', 'ur-roman': 'Barah-e-karam apne sender account/wallet ke aakhri 4 digits darj karein.', ur: 'براہ کرم اپنے ارسال کنندہ اکاؤنٹ یا والٹ کے آخری 4 ہندسے درج کریں۔' },
  'Payment details recognized automatically by AI!': { en: 'Payment details recognized automatically by AI!', 'ur-roman': 'Payment ki tafseelat AI ne khud-ba-khud pehchan lein!', ur: 'ادائیگی کی تفصیلات AI نے خود بخود تلاش کر لیں!' },
  'Could not extract all details automatically. Please verify or fill in manually.': { en: 'Could not extract all details automatically. Please verify or fill in manually.', 'ur-roman': 'Tamam tafseelat auto detect nahi ho sakeen. Barah-e-karam check kar ke khud likh dein.', ur: 'تمام تفصیلات خود بخود نہیں مل سکیں۔ براہ کرم چیک کر کے خود درج کریں۔' },
  'AI is reading receipt to detect Sender details, Transaction ID, Date & Time...': { en: 'AI is reading receipt to detect Sender details, Transaction ID, Date & Time...', 'ur-roman': 'AI receipt parh kar Sender details, Transaction ID, Tareekh aur Waqt detect kar raha hai...', ur: 'AI رسید پڑھ کر ارسال کنندہ کی تفصیلات، ٹرانزیکشن آئی ڈی اور وقت کا پتہ لگا رہا ہے...' },
  ...
  'Claim Reward (+10 Days)': { en: 'Claim Reward (+10 Days)', 'ur-roman': 'Inam Claim Karein (+10 Din)', ur: 'انعام حاصل کریں (+10 دن)' },
  'Claim Signup (+10 Days)': { en: 'Claim Signup (+10 Days)', 'ur-roman': 'Signup Claim Karein (+10 Din)', ur: 'سائن اپ انعام حاصل کریں (+10 دن)' },
  'Signup Claimed (+10)': { en: 'Signup Claimed (+10)', 'ur-roman': 'Signup Claim Ho Gaya (+10)', ur: 'سائن اپ حاصل کر لیا (+10)' },
  'Claim Activation (+10 Days)': { en: 'Claim Activation (+10 Days)', 'ur-roman': 'Activation Claim Karein (+10 Din)', ur: 'ایکٹیویشن انعام حاصل کریں (+10 دن)' },
  'Activation Claimed (+10)': { en: 'Activation Claimed (+10)', 'ur-roman': 'Activation Claim Ho Gaya (+10)', ur: 'ایکٹیویشن حاصل کر لیا (+10)' },
  'Pending activation for +10 days': { en: 'Pending activation for +10 days', 'ur-roman': '+10 din ke liye activation pending hai', ur: '+10 دن کے لیے ایکٹیویشن زیر التواء ہے' },
