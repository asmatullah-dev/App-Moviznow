...
const translations: Record<string, Record<Language, string>> = {
  ...
  'Submit a Review (+3 Days)': { en: 'Submit a Review (+3 Days)', 'ur-roman': 'Review Bhejein (+3 Din)', ur: 'جائزہ جمع کریں (+3 دن)' },
  'Write a review and rate our app to get a free 3 days membership extension.': { en: 'Write a review and rate our app to get a free 3 days membership extension.', 'ur-roman': 'Muft 3 din ki membership barhane ke liye review likhein aur hamari app ko rate karein.', ur: 'مفت 3 دن کی ممبرشپ کی میعاد بڑھانے کے لیے جائزہ لکھیں اور ہماری ایپ کو درجہ دیں۔' },
  ...
  'Write Review (+3 Days)': { en: 'Write Review (+3 Days)', 'ur-roman': 'Review Likhein (+3 Din)', ur: 'جائزہ لکھیں (+3 دن)' },
