  ...
  return (
    <div className="min-h-screen bg-white dark:bg-zinc-950 text-zinc-900 dark:text-white flex flex-col md:flex-row transition-colors duration-300">
      ...
      <aside className={clsx(
        ...
        <p className="text-[10px] text-zinc-500 font-mono tracking-tighter opacity-50 text-center pb-2">v{typeof __APP_VERSION__ !== 'undefined' ? `${__APP_VERSION__} (Referral Addition)` : '2.7.6 (Referral Addition)'}</p>
      </aside>
