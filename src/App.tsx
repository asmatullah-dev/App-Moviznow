...
// Lazy Loaded Pages with automatic retry & cache recovery on deployment updates
...
const About = lazyWithRetry(() => import('./pages/user/About'));
const Contact = lazyWithRetry(() => import('./pages/user/Contact'));
const MovieDetails = lazyWithRetry(() => import('./pages/user/MovieDetails'));
const WatchLater = lazyWithRetry(() => import('./pages/user/WatchLater'));
const Favorites = lazyWithRetry(() => import('./pages/user/Favorites'));
const Trial = lazyWithRetry(() => import('./pages/user/Trial'));
const TopUp = lazyWithRetry(() => import('./pages/user/TopUp'));
const Cart = lazyWithRetry(() => import('./pages/user/Cart'));
const Settings = lazyWithRetry(() => import('./pages/user/Settings'));
const Rewards = lazyWithRetry(() => import('./pages/user/Rewards'));
...
const GenreManagement = lazyWithRetry(() => import('./pages/admin/GenreManagement'));
const LanguageManagement = lazyWithRetry(() => import('./pages/admin/LanguageManagement'));
const QualityManagement = lazyWithRetry(() => import('./pages/admin/QualityManagement'));
const UserManagement = lazyWithRetry(() => import('./pages/admin/UserManagement'));
const UserManagers = lazyWithRetry(() => import('./pages/admin/UserManagers'));
const SelectedContentUsers = lazyWithRetry(() => import('./pages/admin/SelectedContentUsers'));
const CollectionsManagement = lazyWithRetry(() => import('./pages/admin/CollectionsManagement'));
const IncomeManagement = lazyWithRetry(() => import('./pages/admin/IncomeManagement'));
const ErrorLinks = lazyWithRetry(() => import('./pages/admin/ErrorLinks'));
const ReportedLinks = lazyWithRetry(() => import('./pages/admin/ReportedLinks'));
const Notifications = lazyWithRetry(() => import('./pages/admin/Notifications'));
const MovieRequestsManagement = lazyWithRetry(() => import('./pages/admin/MovieRequestsManagement'));
const OrdersManagement = lazyWithRetry(() => import('./pages/admin/OrdersManagement'));
const AdminSettings = lazyWithRetry(() => import('./pages/admin/AdminSettings'));
const ReferralsManagement = lazyWithRetry(() => import('./pages/admin/ReferralsManagement'));
const ContentSync = lazyWithRetry(() => import('./pages/admin/ContentSync'));
